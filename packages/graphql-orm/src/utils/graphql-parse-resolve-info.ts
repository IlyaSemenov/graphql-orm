...
//
// Copy of graphql-parse-resolve-info.
//
// Copy/paste from https://github.com/graphile/graphile-engine/blob/9d6c29e3505844ca64020fb6850093a7678a0fa4/packages/graphql-parse-resolve-info/src/index.ts
// with import fixes.
//
// The original graphql-parse-resolve-info lists graphql 14 as a peer dependency.
// Copy/pasting it here prevents unmet peer dependency errors in projects using graphql-orm.
//
// Uses fake debug instead of npm debug (via tsconfig.paths)
...
import debugFactory from "./graphql-parse-resolve-info-debug"
